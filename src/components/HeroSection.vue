    ...
    <div class="relative z-10 mx-auto w-full max-w-7xl px-6 py-28 lg:px-8 xl:px-16">
      <div class="lg:max-w-3xl">
        ...
        <div class="delay-300 animate-fade-up mt-12 flex flex-wrap flex-col lg:flex-nowrap lg:flex-row gap-8">
          ...
          <div class="w-px self-stretch bg-white/15 mx-2 hidden sm:block" />
          <div class="flex flex-col gap-1">
            <div class="font-display font-700 text-white" style="font-size: clamp(2rem, 3.5vw, 2.75rem); line-height: 1;">100%</div>
            <div class="font-body text-xs font-400 uppercase tracking-widest text-white/50">Индивидуальный подход</div>
          </div>
        </div>
