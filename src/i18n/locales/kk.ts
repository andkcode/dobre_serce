export default {
  ...
  seo: {
    default: {
      title: 'Доброе сердце – қарт адамдарға арналған пансионат Астанада',
      description: '«Доброе сердце» пансионаты қарт адамдарға күн бойы күтім, медициналық қолдау, жайлы тұрмыс және сенімді қамқорлық ұсынады.',
      keywords: 'пансионат, қарт адамдарға күтім, қарттар үйі, медициналық күтім, 24/7 күтім, Астана, Доброе сердце, ұзақ уақыт күтім, дневной стационар, реабилитация, қарты адамдар, құлықсын адамдар, ынамды қызмет',
    },
  },
  ...
  reviews: {
    eyebrow: 'Пікірлер',
    titleBlue: 'Бізге сенеді',
    titleGold: 'туыстар мен жақындар',
    subtitle:
      'Тәуелсіз платформалардағы пансионат туралы пікірлерді қарап, бізді таңдаған отбасылардың әсерімен танысыңыз.',
    cta: 'Көбірек пікір ашу',
    platformLabel: 'Платформа',
    note: 'Өзекті бағалар мен пікірлер',
    linkLabel: 'Қарау',
  },
